...
$tableName = $installer->getTable('hackathon_ordertransaction/order_status_history_seq');
...
->setComment('Order Status History ID Sequence Table');
$installer->getConnection()->createTable($table);


/* @var $resource Mage_Sales_Model_Resource_Order_Status_History */
$resource = Mage::getResourceModel('sales/order_status_history');
